...
#[0.55631616 0.2171536  0.21002341]
...
def SSR(params0, LocOfTM, LocOfsrc, LocOfRunVars, LocOfOutput):
    ...
    plt.plot(Time_ave, T_ave)
    plt.plot(Time_ave, I_ave)
    plt.plot(Time_ave, D_ave)
...
#sampler = np.load("mcmc_sampler.npy", allow_pickle=True).item()
