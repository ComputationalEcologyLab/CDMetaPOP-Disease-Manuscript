...
# Static spatial spread (Fig 3) --------------------------------------------

# Read in data
Fig_3_data<- readRDS(paste0(input_dir, "/Fig_3_data.Rds"))
...
# Read in data
Fig_3_supplemental_data<- readRDS(paste0(input_dir, "/Fig_3_supplemental_data.Rds"))
...
for (batch in batch_nums_spatial) {
  combined_sf<- Fig_3_supplemental_data[[as.character(batch)]]
