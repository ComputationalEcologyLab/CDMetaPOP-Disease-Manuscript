            ...
            for j in range(51):
                try:
                    if "SEIR" in base_path:
                        values = df["States_SecondUpdate_AfterDeathsRemoved"][j].split('|')[0].split(';')
                        ...
                        values = df.iloc[j, 5].split('|')[0].split(';')
                        for k, c in enumerate(compartments):
                            temp[c].append(float(values[k]))
                except:
                    continue
...
model_configs = {
    "SIR": {
        "base_path": r"\\maa1.cc.lut.fi\home\h18324\Documents\CDMetaPOP-master\run0batch0mc99species0_SIR_noSD",
        "prefix": "run0batch0mc",

        "comps": ['S', 'I', 'R']
    },
    "SIRS": {
        "base_path": r"C:\Users\h18324\Downloads\run0batch1mc99species0_SIRS_noSD",
        "prefix": "run0batch1mc",
        "comps": ['S', 'I', 'R']
    },
    "SEIR": {
        "base_path": r"C:\Users\h18324\Downloads\run0batch2mc99species0_SEIR_noSD",
        "prefix": "run0batch2mc",
        "comps": ['S', 'E', 'I', 'R']
    },
    "SIRP": {
        "base_path": r"C:\Users\h18324\Downloads\SIRP_batch\SIRP_mc",
        "prefix": "run0batch0mc",
        "comps": ['S', 'I', 'R', 'P']
    }
}
...
labels = ['a', 'b', 'c', 'd']
#colors = {'S': 'blue', 'E': 'orange', 'I': 'red', 'R': 'green', 'P': 'purple'}
colors = {
    'S': '#56B4E9',     # Sky Blue
    'E': '#E69F00',     # Orange
    'I': '#D55E00',     # Vermillion
