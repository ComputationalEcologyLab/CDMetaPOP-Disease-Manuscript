...
#	exit(0)
##	print(np.sum(states))
#	states = np.zeros(int(Nspecies[ispec])*len(Nspecies)*len(K))
#	init_infect = 0.1
#	random_indices = np.random.choice(np.arange(states.size), replace=False, size=int(states.size * init_infect))
#	states[random_indices] = 1
